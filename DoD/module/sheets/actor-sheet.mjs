 ...
 * @extends {ActorSheet}
 */
export class DoDrpgActorSheet extends ActorSheet {

  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["DoDrpg", "sheet", "actor"],
      template: "systems/DoD/templates/actor/actor-sheet.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/DoD/templates/actor/actor-${this.actor.type}-sheet.html`;
  }
  ...
  _prepareActorData(context) {
    ...
    for (let [k, v] of Object.entries(context.data.saves)) {
      v.label = game.i18n.localize(CONFIG.DoDrpg.saves[k]) ?? k;
    }
  }
  ...
  _prepareCharacterData(context) {
    ...
    for (let [k, v] of Object.entries(context.data.abilities)) {
      v.label = game.i18n.localize(CONFIG.DoDrpg.abilities[k]) ?? k;
    }
    // Handle money.
    for (let [k, v] of Object.entries(context.data.money)) {
      v.label = game.i18n.localize(CONFIG.DoDrpg.money[k]) ?? k;
    }
  }
