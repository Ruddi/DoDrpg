...
import { DoDrpgActor } from "./documents/actor.mjs";
import { DoDrpgItem } from "./documents/item.mjs";
// Import sheet classes.
import { DoDrpgActorSheet } from "./sheets/actor-sheet.mjs";
import { DoDrpgItemSheet } from "./sheets/item-sheet.mjs";
// Import helper/utility classes and constants.
import { preloadHandlebarsTemplates } from "./helpers/templates.mjs";
import { DoDrpg } from "./helpers/config.mjs";
...
Hooks.once('init', async function() {
  ...
  CONFIG.Actor.documentClass = DoDrpgActor;
  CONFIG.Item.documentClass = DoDrpgItem;

  // Register sheet application classes
  Actors.unregisterSheet("core", ActorSheet);
  Actors.registerSheet("DoDrpg", DoDrpgActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("DoDrpg", DoDrpgItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.DoDrpg.rollItemMacro("${item.name}");`;
